...
| 守   | 防守棋 | 横纵线任意格数，横向可吃子                     |
| 援   | 应援棋 | 斜线任意格数，可吃敌方棋子                     |
| 法   | 魔法阵 | 中心区域内每步1格，仅上下左右移动（不可斜走） |
| 将   | 胜点棋 | 九宫格内每步1格，仅上下左右移动（不可斜走）   |
...
本桌游规则来源于 **雪库房** 社团，本项目仅为同人爱好者根据桌游规则实现的网页版本。

如果你对原版桌游感兴趣，欢迎关注官方渠道获取更多信息：

![冬恋三九活动信息](asset/冬恋三九活动信息.png)

**雪库房的观众群**：QQ群 `1022442412`

> 以上信息来自官方，本项目开发者并非官方成员。
